...
<div class="container">
    <div class="registration-form">
        ...
        <form name="EditCustomer" action="" method="POST" >
            ...
            <div class="form-group"><label>Comfort:</label>
                <input type="text"  class="form-control item"
             <@spring.formInput "edit.comfort" "" "text" /></div>

            <div class="form-group"><label>Capacity:</label>
                <input type="text"  class="form-control item"
             <@spring.formInput "edit.capacity" "" "text" /></div>


            <div class="form-group"><label>Price:</label>
                <input type="text"  class="form-control item"
             <@spring.formInput "edit.price" "" "text" /></div>
            ...
            <input type=submit value="Update room" class="btn btn-block create-account">
